...
export default function Screen1({ navigation }) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
            <Image style={{ width: 250, height: 280, marginTop: 50, alignSelf: 'center' }} source={link} />
            ...
            <TouchableOpacity activeOpacity={0.5} style={{ flexDirection: "row", borderRadius: 10, borderWidth: 0.8, width: 332, height: 50, alignSelf: 'center', justifyContent: 'center', marginVertical: 10, backgroundColor: 'red' }}>
